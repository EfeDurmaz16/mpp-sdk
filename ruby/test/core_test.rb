...
class CoreTest < Minitest::Test
  ...
  def test_json_parser_and_header_error_branches
    ...
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_www_authenticate("Bearer token") }
    # Token-form values are valid per RFC 7235 sec 2.1.
    assert_equal({"id" => "abc"}, PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_auth_params("id=abc"))
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_auth_params("=value") }
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_auth_params("id=a, id=b") }
  end

  def test_parse_auth_params_token_form_values
    params = PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_auth_params("id=abc, realm=api, method=solana, intent=charge, request=e30")
  ...
  def test_parse_www_authenticate_all_multi_challenge
    ...
    results = PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_www_authenticate_all([h])
  ...
  def test_split_payment_challenge_values_edges
    ...
    assert_empty PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_www_authenticate_all(["Bearer xyz"])
    # Tab after Payment.
    h = "Payment\tid=\"x\", realm=\"api\", method=\"solana\", intent=\"charge\", request=\"e30\""
    parsed = PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_www_authenticate_all([h])
  ...
  def test_payment_scheme_start_negatives
    ...
    assert_empty PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_www_authenticate_all(["Paymentid=x"])
    # Payment preceded by non-comma is not a scheme start.
    assert_empty PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_www_authenticate_all(["X Payment id=x"])
  end

  def test_parse_auth_params_branches
    # BWS around `=`.
    params = PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_auth_params('id ="x" , realm="api"')
    assert_equal "x", params.fetch("id")
    assert_equal "api", params.fetch("realm")
    # Multi-challenge empty header.
    assert_empty PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_www_authenticate_all([])
    # Single-value challenge through all helper.
    h = 'Payment id="x", realm="api", method="solana", intent="charge", request="e30"'
    assert_equal 1, PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_www_authenticate_all([h]).length
  end

  def test_header_parser_unescapes_quoted_values
    params = PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_auth_params('realm="api\"quoted", id="x"')

    assert_equal 'api"quoted', params.fetch("realm")
    assert_equal "x", params.fetch("id")
    assert_empty PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_auth_params(" , \t ")
  end
  ...
  def test_challenge_header_round_trip_and_hmac
    ...
    parsed = PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_www_authenticate(PayKit::Protocols::Mpp::Protocol::Core::Headers.format_www_authenticate(challenge))
  ...
  def test_credential_authorization_round_trip
    ...
    credential = PayKit::Protocols::Mpp::Protocol::Core::Credential.new(challenge: challenge.to_echo, payload: {"signature" => "1" * 87})

    parsed = PayKit::Protocols::Mpp::Protocol::Core::Credential.from_authorization_header(credential.to_authorization_header)

    assert_equal challenge.id, parsed.challenge.id
    assert_equal "1" * 87, parsed.payload["signature"]

    sourced = PayKit::Protocols::Mpp::Protocol::Core::Credential.new(challenge: challenge.to_echo, payload: {"signature" => "1" * 87}, source: "wallet")
    assert_equal "wallet", sourced.to_h.fetch("source")
  end

  def test_challenge_and_credential_validation_edges
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Challenge.new(id: "", realm: "api", method: "solana", intent: "charge", request: "x") }
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Challenge.new(id: "id", realm: "", method: "solana", intent: "charge", request: "x") }
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Challenge.new(id: "id", realm: "api", method: "Solana", intent: "charge", request: "x") }
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Challenge.new(id: "id", realm: "api", method: "solana", intent: "", request: "x") }
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Challenge.new(id: "id", realm: "api", method: "solana", intent: "charge", request: "") }
    ...
    refute PayKit::Protocols::Mpp::Protocol::Core::Challenge.new(id: "short", realm: challenge.realm, method: challenge.method, intent: challenge.intent, request: challenge.request).verify?("secret")
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Credential.from_authorization_header("Bearer token") }
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Credential.from_authorization_header("Payment #{"a" * (PayKit::Protocols::Mpp::Protocol::Core::Credential::MAX_TOKEN_LENGTH + 1)}") }
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Credential.new(challenge: challenge.to_echo, payload: "bad") }
    assert_raises(ArgumentError) { PayKit::Protocols::Mpp::Protocol::Core::Credential.from_authorization_header("Payment #") }
  ...
  def test_receipt_header_round_trip
    ...
    parsed = PayKit::Protocols::Mpp::Protocol::Core::Headers.parse_receipt(PayKit::Protocols::Mpp::Protocol::Core::Headers.format_receipt(receipt))
