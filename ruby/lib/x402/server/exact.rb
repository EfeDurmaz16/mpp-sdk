...
module X402
  module Server
    ...
    class Exact
      ...
      Types = ::X402::Protocol::Schemes::Exact
      Verifier = ::X402::Protocol::Schemes::Exact::Verifier
      Constants = ::X402::Constants
      ...
      # `X402::Server::Exact` namespace so callers can reuse the
      ...
      class << self
        ...
        def settle_exact_payment(config, payment_header, resource: nil)
          ...
          unless config.settlement_cache.put_if_absent(signature_consumed_key(signature))
            raise ::X402::Error::SignatureConsumed::TOKEN
          end
