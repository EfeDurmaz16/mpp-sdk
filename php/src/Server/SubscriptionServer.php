...
final class SubscriptionServer
{
    ...
    public function createChallenge(SubscriptionRequest $request, string $expires = '', string $digest = '', ?string $opaque = null): Challenge
    {
    ...
    public function createChallengeHeader(SubscriptionRequest $request, string $expires = '', string $digest = '', ?string $opaque = null): string
    {
    ...
    public function verifyAuthorizationHeader(
        ...
        if ($challenge->method !== $this->method || $challenge->intent !== 'subscription') {
        ...
        try {
            SubscriptionRequest::fromArray($challenge->decodeRequest());
        } catch (InvalidArgumentException $error) {
            return VerificationResult::failure($error->getMessage());
        }
