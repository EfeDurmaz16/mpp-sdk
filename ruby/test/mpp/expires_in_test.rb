...
class MppExpiresInTest < Minitest::Test
  def test_expires_seconds_returns_rfc3339_at_offset
    ...
    result = ::PayKit::Protocols::Mpp::Expires.seconds(42, now: now)
  ...
  def test_challenge_store_default_expires_seconds
    store = ::PayKit::Protocols::Mpp::Protocol::Core::ChallengeStore.new(secret_key: "secret", realm: "Test")
    assert_equal 300, store.default_expires_seconds
  end

  def test_challenge_store_honors_custom_default_expires_seconds
    store = ::PayKit::Protocols::Mpp::Protocol::Core::ChallengeStore.new(
  ...
  def test_mpp_create_threads_expires_in
    ...
    server = ::PayKit::Protocols::Mpp.create(method: method, secret_key: "secret", realm: "Test", expires_in: 42, replay_store: ::PayKit::Protocols::Mpp::MemoryStore.new)
