  ...
  module Server
    class ChargeServer
      ...
      def verify_authorization_header(authorization_header, verifier:, now: Time.now)
        ...
        return VerificationResult.failure('challenge method or intent mismatch') if challenge.method != method || challenge.intent != 'charge'
        ...
        Intents::ChargeRequest.from_h(challenge.decode_request)
